...
const JobDelete = ({ handleOpenModal, companyDetails }) => {
    ...
    const handleDelete = (id) => {
        axios.delete(`https://server-devjob.chvt.me/deleteTechno/${id}`).then((response) => {
            // console.log('techno deleted successfully', response);
            axios.delete(`https://server-devjob.chvt.me/deleteTool/${id}`).then((response) => {
                // console.log('tools deleted successfully', response);
                axios.delete(`https://server-devjob.chvt.me/delete/${id}`).then((response) => {
